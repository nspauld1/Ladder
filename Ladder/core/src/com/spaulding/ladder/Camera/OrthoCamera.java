package com.spaulding.ladder.Camera;
...
public class OrthoCamera extends OrthographicCamera{
    ...
    public OrthoCamera() {
        this(new VirtualViewport(Main.WIDTH, Main.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(Main.WIDTH, Main.HEIGHT);
